...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("skin")
    .setDescription("Affiche le skin d'un joueur")
  ...
  async execute(client, interaction, config) {
    ...
    const apiUrl = `https://www.earthquest.fr/api/assets/uploads/skins/${pseudo}/skin.png`;
    ...
    const container = new ContainerBuilder()
      ...
      .addTextDisplayComponents((textDisplay) =>
        textDisplay.setContent(
          `## 👥 Skin de ${username.replace(/_/g, "\\_")}`,
        ),
      )
      .addSeparatorComponents((separator) => separator)
      .addMediaGalleryComponents((g) =>
        g.addItems((item) => item.setURL(`attachment://skin_${pseudo}.png`)),
      )
      .addSeparatorComponents((separator) => separator)
    ...
    await interaction.reply({
      ...
      files: [{ name: `skin_${pseudo}.png`, attachment: imageBuffer }],
    });
  },
};
